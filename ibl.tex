...
\begin{ex}
\addtocounter{exercisepartscount}{-5}  % This is not 6 separate exercises, it is one
...
if it is a function find the range.  
\begin{ans}
\begin{exes}
...
an inverse of~$f$ (or a \definend{two-sided inverse} for emphasis). 
