...
\medskip
\noindent\textsc{Process.}
Each class day starts with students going to the board to propose solutions to
the homework exercises.
(Some exercises have multiple items; these come in two kinds.
If the items are labeled alphabetically \textsc{A.}, \textsc{B.}, etc., 
then I ask separate students to answer each item.
If the labels are (i), (ii), etc., then 
I ask one student to do them all.)
The class thoroughly discusses each one 
and often considerably revises it.
Finally, 
each class ends with the homwork assignment of the next few exercises.
