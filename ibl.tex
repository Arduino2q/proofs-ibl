...
prove that our example statement is true for all~$n\geq 0$.
...
In this way, we bootstrap to all numbers~$n\geq 0$.
...
\begin{proof}
  ...
  This is the required expression for the $k+1$~case.
\end{proof}
...
\begin{ans}
The $n=0$ base step is the commutativity assumption $a_0+a_1=a_1+a_0$.

For the inductive step assume the statement is true for all 
sums of~$n+1$ terms with 
with $0\leq n\leq k$, and consider a sequence with $n=k+2$~terms.
We have 
