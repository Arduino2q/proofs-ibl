...
\begin{ex}[Interaction of parity and sign] 
...
\item With the prior item in mind we first show that a number is even
...
\begin{ex}[Interaction of parity and addition]
\pord.
\begin{exes}
...
\begin{ex}[Interaction of parity and multiplication]
\pord.
\begin{exes}
