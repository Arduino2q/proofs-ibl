...
\item Suppose that $d, n, m\in\Z$ are such that $d\divides n$ and
  ...
  $d$ divides~$m$.
\item Let $d,a,b\in\Z$ and suppose that $d\divides a$ and $d\divides b$.
  Then $a=dk$ and $b=dm$ for some $k,m\in\Z$ so 
  $a+b=dk+dm=d\cdot(k+m)$.
  Thus $d\divides (a+b)$.
\item Fix~$d,n\in\Z$.
...
\item First consider a divisor~$d$ of~$1$ that is a positive integer.
...
For the proof, $a\divides b$ implies that $b=ak$ and~$b\divides a$
implies that $a=bm$ for some $k,m\in\Z$.
Substitution gives $a=bm=akm$, and by cancellation $1=km$ (cancellation
