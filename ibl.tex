...
whereas a month of background material can be an initial damper.

But the background is good stuff also and 
students like it once they see where it goes.
In the second chapter and third chapters we cover 
sets, functions, and relations, now with the
intellectual habits we've established in the first chapter.
...
on proving things, but students get what
they need at the moment when they can appreciate it.

The only exception is that here we cover induction as a separate
...
Observe that although $g$ comes first when reading the $\composed{g}{f}$ 
from left to right, 
$g$ is not the function that is applied first. 
