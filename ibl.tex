...
with the instructor only ligltly guiding, 
...
\medskip
\textsc{Logic topics.}
This book start with elementary number theory, not truth tables, 
for the same reason
that Little League starts by playing ball, not with the rulebook.
Mathematics majors readily jump into proving things about
divisibility and primes, enjoying this new work with its verbal and
intellectual back-and-forth, 
whereas starting with a month of preliminary material would not 
develop the same enthusiasm.

But the underlying logic is good stuff, and besides, they need it.
In my course, daily classes begin with some of the students going to the 
board to write their answers to the homework. 
I use these ten minutes for a slide or two that addresses issues from
...
topic, since it is sifficiently difficult as to require the class's 
full attention.    
